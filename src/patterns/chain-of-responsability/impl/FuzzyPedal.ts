...
export class FuzzyPedal implements IPedal {
	...
	process(audioConfig: AudioSignal): void {
		if(audioConfig.pedals.includes("fuzzy")) {
			console.log('FuzzyPedal: processing audio signal...');
			audioConfig.audioSignal += ' + fuzz';
		}
